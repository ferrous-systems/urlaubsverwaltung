...
public enum FederalState {
    ...
    PORTUGAL_CASTELOBRANCO_BELMONTE("pt", "05", "BMT"),
    PORTUGAL_CASTELOBRANCO_COVILHA("pt", "05", "CVL"),
    PORTUGAL_CASTELOBRANCO_CASTELOBRANCO("pt", "05", "CTB"),
    PORTUGAL_CASTELOBRANCO_FUNDAO("pt", "05", "FND"),
    PORTUGAL_CASTELOBRANCO_IDANHAANOVA("pt", "05", "IDN"),
    PORTUGAL_CASTELOBRANCO_OLEIROS("pt", "05", "OLR"),
    PORTUGAL_CASTELOBRANCO_PENAMACOR("pt", "05", "PNC"),
    PORTUGAL_CASTELOBRANCO_PROVENCAANOVA("pt", "05", "PNV"),
    PORTUGAL_CASTELOBRANCO_SERTA("pt", "05", "SRT"),
    PORTUGAL_CASTELOBRANCO_VILADEREI("pt", "05", "VLR"),
    PORTUGAL_CASTELOBRANCO_VILAVELHADERODAO("pt", "05", "VVR"),
    PORTUGAL_LISSABON_ALENQUER("pt", "11", "ALQ"),
    PORTUGAL_LISSABON_AMADORA("pt", "11", "AMD"),
    PORTUGAL_LISSABON_ARRUDADOSVINHOS("pt", "11", "ARV"),
    PORTUGAL_LISSABON_AZAMBUJA("pt", "11", "AZB"),
    PORTUGAL_LISSABON_CASCAIS("pt", "11", "CSC"),
    PORTUGAL_LISSABON_LISBOA("pt", "11", "LSB"),
    PORTUGAL_LISSABON_LOURES("pt", "11", "LRS"),
    PORTUGAL_LISSABON_LOURINHA("pt", "11", "LRH"),
    PORTUGAL_LISSABON_MAFRA("pt", "11", "MFR"),
    PORTUGAL_LISSABON_ODIVELAS("pt", "11", "ODV"),
    PORTUGAL_LISSABON_OEIRAS("pt", "11", "OER"),
    PORTUGAL_LISSABON_SINTRA("pt", "11", "SNT"),
    PORTUGAL_LISSABON_SOBRALDEMONTEAGRACO("pt", "11", "SMA"),
    PORTUGAL_LISSABON_TORRESVEDRAS("pt", "11", "TVD"),
    PORTUGAL_LISSABON_VILAFRANCADEXIRA("pt", "11", "VFX"),
    PORTUGAL_SETUBAL_ALCACERDOSAL("pt", "15", "ASL"),
    PORTUGAL_SETUBAL_ALCOCHETE("pt", "15", "ACH"),
    PORTUGAL_SETUBAL_ALMADA("pt", "15", "ALM"),
    PORTUGAL_SETUBAL_BARREIRO("pt", "15", "BRR"),
    PORTUGAL_SETUBAL_GRANDOLA("pt", "15", "GDL"),
    PORTUGAL_SETUBAL_MOITA("pt", "15", "MTA"),
    PORTUGAL_SETUBAL_MONTIJO("pt", "15", "MTJ"),
    PORTUGAL_SETUBAL_PALMELA("pt", "15", "PLM"),
    PORTUGAL_SETUBAL_SANTIAGODOCACEM("pt", "15", "STC"),
    PORTUGAL_SETUBAL_SEIXAL("pt", "15", "SXL"),
    PORTUGAL_SETUBAL_SESIMBRA("pt", "15", "SSB"),
    PORTUGAL_SETUBAL_SETUBAL("pt", "15", "STB"),
    PORTUGAL_SETUBAL_SINES("pt", "15", "SNS"),
